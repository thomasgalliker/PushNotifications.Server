...
using FcmLegacyRequest = PushNotifications.Server.Google.Legacy.FcmRequest;
using FcmLegacyResponse = PushNotifications.Server.Google.Legacy.FcmResponse;
using FcmRequest = PushNotifications.Server.Google.FcmRequest;
using FcmResponse = PushNotifications.Server.Google.FcmResponse;
